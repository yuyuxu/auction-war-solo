...
% carve up the data into small groups according to svo
% analysis_markov(data_cat(y_svo_bin == 0, :), 5, print_label, print_label);
% analysis_markov(data_cat(y_svo_bin == 1, :), 5, print_label, print_label);

% carve up the data into small groups according to age
% below 28, 29 - 50, above 50
% ages = str2double(D(1:end, 8));
% analysis_markov(data_cat(ages < 28, :), 5, print_label, print_label);
% analysis_markov(data_cat(ages >= 28 & ages < 45, :), 5, print_label, print_label);
% analysis_markov(data_cat(ages >= 45, :), 5, print_label, print_label);
...
%   end
% end
% analysis_markov(data_cat(gender == 0, :), 5, print_label, print_label);
% analysis_markov(data_cat(gender == 1, :), 5, print_label, print_label);
...
%   end
% end
% analysis_markov(data_cat(education == 0, :), 5, print_label, print_label);
% analysis_markov(data_cat(education == 1, :), 5, print_label, print_label);
% analysis_markov(data_cat(education == 2, :), 5, print_label, print_label);
